    ...
    return (
        <>
            ...
            <TeamContainer>
                ...
                <Member>
                    <Image src="https://i.imgur.com/FkU3CpS.png"></Image>
                    <h2>Richard Gannon</h2>
                    <IconsDiv>
                        <Github href="https://github.com/inkyblinkypinkyclyde"><i className="fa fa-github icon fa-3x"></i></Github>
                        <LinkedIn href="https://www.linkedin.com/in/richard-gannon-66b49322a/"><i className="fa fa-linkedin icon fa-3x"></i></LinkedIn>
                    </IconsDiv>
                </Member>
                <Member>
